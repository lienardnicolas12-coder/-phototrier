...
class PhotoSorterApp(QMainWindow):
    ...
    def setup_settings_tab(self):
        ...
        # ========== DOSSIER DE STOCKAGE ==========
        storage_group = QGroupBox("📁 DOSSIER DE STOCKAGE")
        ...
        # ========== CATÉGORIES ==========
        categories_group = QGroupBox("📁 CATÉGORIES")
        ...
        edit_category_btn = QPushButton("✏️ Modifier")
    ...
    def stop_watchdog(self):
        if self.watchdog_worker:
            ...
            self.watchdog_worker = None
            self.log_message("🗑️ Surveillance arrêtée.")
